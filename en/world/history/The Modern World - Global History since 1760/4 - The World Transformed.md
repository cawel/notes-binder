...
* compared to the period 1500-1820, the annual average growth rate of per capita GDP in Asia (excluding Japan) from 1820-1870 is decreasing both absolutely and relative to Western Europe

## Eurasian ends have in common
...
## Eurasian ends differ in: 
* resources (superior trading networks, New World)
* technology (fossil fuel)

## Discovery: Steam Engines
* Boulton has been working on steam engine, sponsored by private enterprises
...
* protectionist legislation to keep out the imports the textiles from India
* and it created incentives to build steam engines

## Discovery: electricity
* Alessandra Volta worked on that
* contribution by Gauss (several significant contributions in 6-7 fields)
* Michael Faraday worked on that
* layering of understandings
...
* motivation: scientific interest
...
* their motivation is the reward from the community peers
...
## Cultural change
* missionary zeal (spreading education, science, religions)
...
* traditional Islamic world:
  ...
  * learned religious elite (religious, they don't consider them part of the gvt, but they are nevertheless in charge for the administration of justice)
  * everyone else
...
* fight between between Egypt and the Ottoman Empire
  ...
  * they see the Ottoman bulwark against the expansion of a European rival: Russian Empire
